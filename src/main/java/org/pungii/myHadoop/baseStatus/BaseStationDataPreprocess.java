package org.pungii.myHadoop.baseStatus;
...
/**
 * 汇总基站数据表 计算每个用户在不同的时间段不同的基站停留的时长 输入参数 < input path > < output path > < date > < timepoint > 参数示例：
 * “/base /output 2012-09-12 09-17-24"
    ...
    public static class Reduce extends Reducer<Text, Text, NullWritable, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context) throws IOException,
            ...
            for (Text value : values) {
                ...
                try {
                    uploads.put(Long.valueOf(valueString.split("\\|")[1]),
                            valueString.split("\\|")[0]);
            ...
            try {
                // 在最后添加“OFF”位置
                Date tmp =
                        this.formatter.parse(this.date + " " + timeFlag.split("-")[1] + ":00:00");
