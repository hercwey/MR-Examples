package org.pungii.myHadoop.mr.kpi;
...
public class KPIAna {
    ...
    public static void main(String[] args) throws Exception {
        String input = SystemConfig.HDFS_URL+"user/hdfs/log_kpi";
        String output = SystemConfig.HDFS_URL+"user/hdfs/log_kpi/time";

        JobConf conf = new JobConf(KPIAna.class);
